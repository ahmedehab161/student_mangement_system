...
<head>
    ...
    <title>Doctor And Subject</title>
...
<body>
    <div class="page d-flex">
        <div class="si">
            <div class="sidebar bg-white p-20 p-relative">
                ...
                <ul>
                    <li>
                        <a class="d-flex align-center fs-14 c-black rad-6 p-10 links" href="php/logout.php">
                    ...
                    <li>
                        <a class="d-flex  align-center fs-14 c-black rad-6 p-10 links" href="teaching asstance.php">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/>
                              </svg>
                    ...
                    <li>
                        <a class="d-flex  align-center fs-14 c-black rad-6 p-10 links" href="Add Subject.php">
                    ...
                    <li>
                        <a class="d-flex active align-center fs-14 c-black rad-6 p-10 links" href="doctor and subject.php">
        ...
        <div class="content w-full">
                                ...
                                <div class="modal-body">
                                    <form action="#" method="POST">
                                        <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-select" id="inputGroupSelect01" name="subjects" >
                                                        <?php
                                        ...
                                        <div class="input-group mb-3">
                                           ...
                                           <select class="form-select" id="inputGroupSelect01" name="drName" >
                                               <?php
                               ...
                               <div class="input-group mb-3">   
                                ...
                                <!-- #region -->          
                                        ...
                                        <div class="form-check form-switch">
                                                    <li> 
                                                       <input class="form-check-input" type="checkbox" value="Hall" role="switch" id="flexSwitchCheckChecked" name="class[]" >
                                        ...
                                        <div class="form-check form-switch">
                                            <li>      
                                                <input class="form-check-input" type="checkbox" value="Section" role="switch" id="flexSwitchCheckChecked" name="class[]" >
                                        ...
                                        <div class="form-check form-switch">
                                            <li>      
                                                <input class="form-check-input" type="checkbox" value="Lab" role="switch" id="flexSwitchCheckChecked" name="class[]" >
            ...
            <div class="modal-content formes">
                ...
                <div class="doc-but">
                    <h1 class="p-relative">Doctor And Subject</h1>
                    ...
                    <table class="table">
                        ...
                        <?php
                                    ...
                                    <tr>
                                        ...
                                        <a  href='doctor and subject.php?Id=".$result['Id']."'>  
    ...
    <script src="js/app-dr-sub.js"></script>
</body>
</html>