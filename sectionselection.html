...
<body>
    <div class="page d-flex">
        ...
        <div class="content w-full">
            ...
            <!-- End Head -->
            <div class="row row-cols-1 row-cols-md-3 g-4 formes-st">
                <div class="col cerd">
                    <div class="card img-car">
                        <img src="imgs/team-01.png" class="card-img-top img-car" alt="...">
                        <div class="card-body tit-car">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-plus-fill ico" viewBox="0 0 16 16">
                                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                                <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
                              </svg>
                            <a href="add student eng.php" class="links">
                                <h6 class="card-title">Add Engineering</h6>
                            </a>
                ...
                <div class="col cerd">
                    <div class="card img-car">
                        <img src="imgs/team-03.png" class="card-img-top img-car" alt="...">
                        <div class="card-body tit-car">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-plus-fill ico" viewBox="0 0 16 16">
                                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                                <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
                              </svg>
                            <a href="add student cs.php" class="links">
                                <h6 class="card-title">Add Computer Science</h6>
                            </a>
                ...
                <div class="col cerd">
                    <div class="card img-car">
                        <img src="imgs/team-05.png" class="card-img-top img-car" alt="...">
                        <div class="card-body tit-car">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-plus-fill ico" viewBox="0 0 16 16">
                                <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                                <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
                              </svg>
                            <a href="add student manag.php" class="links">
                                <h6 class="card-title">Add Business Management</h6>
                            </a>
                        </div>
                    </div>
                </div>
